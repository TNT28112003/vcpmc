...
import ModalComponents from './component/MainModal/ModalTest';
...
const Test = () => {
  ...
  const items: MenuProps['items'] = [
    {
      label: formatMessage('test.delete'),
      key: '1',
      icon: <DeleteOutlined />,
    ...
    switch (key) {
      case '1':
        DeleteConfirm({
          ...
          content: formatMessage('test.content.delete'),
          handleOk: () => {
  ...
  return (
    <div className="test">
      <div className="main-card">
        <MainTitleComponent breadcrumbs={routerTest} />
        <div className="flex flex-row justify-between mb-2.5">
          ...
          <div className="wrap_btn intro-y">
            <ButtonComponent
              mr_2={true}
              icon={<PlusOutlined />}
              text={formatMessage('test.create')}
              onClick={() => {
                setModal({
                  isVisible: true,
                  dataEdit: null,
